...
void test(std::string name) {
    ...
    cv::imwrite("lesson09/resultsData/" + name + "_2_hough_normalized.png", hough);
    ...
    cv::imwrite("lesson09/resultsData/" + name + "_3_hough_blurred.png", hough); // и сохраянем его визуализацию на диск:
    ...
    int radius = 5;
    cv::Mat houghWithCircles = drawCirclesOnExtremumsInHoughSpace(hough, lines, radius);
